...
public class FaceView: UIView
{
    ...
    @IBInspectable
    public var scale: CGFloat = 0.90 { didSet { setNeedsDisplay() } }
    @IBInspectable
    public var mouthCurvature: Double = 1.0 { didSet { setNeedsDisplay() } }
    @IBInspectable
    public var eyesOpen: Bool = false { didSet { setNeedsDisplay() } }
    @IBInspectable
    public var eyeBrowTilt: Double = -0.5 { didSet { setNeedsDisplay() } }
    @IBInspectable
    public var color: UIColor = UIColor.blueColor() { didSet { setNeedsDisplay() } }
    @IBInspectable
